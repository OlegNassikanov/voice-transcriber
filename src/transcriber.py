#!/usr/bin/env python3
"""
Голосовой транскрибатор для Fedora (OpenAI Whisper)
Требует: pip install PyQt5 pyaudio openai-whisper pyperclip numpy
"""
...
class VoiceTranscriber(QMainWindow):
    ...
    def init_ui(self):
        ...
        if torch.cuda.is_available():
            ...
            device_label.setText(f"Устройство (GPU: {torch.cuda.get_device_name(0)}):")
        else:
    ...
    def load_model(self):
        ...
        try:
            ...
            # Загружаем модель OpenAI Whisper
    ...
    def transcribe_audio(self):
        ...
        try:
            ...
            result = self.model.transcribe(
                ...
                fp16=False,  # Всегда используем fp32 для совместимости
            )
